...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-pink-800 to-rose-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-pink-400 font-medium">Designer Collection</span>
            </div>
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">
              Discover stunning party dresses, club wear, and modeling outfits that make you the center of attention.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8">
              <div>
                ...
                <div className="text-gray-300">Designer Dresses</div>
              </div>
              <div>
          ...
          <div className="relative">
            <div className="relative w-full h-96 lg:h-[600px] rounded-3xl overflow-hidden">
              <img 
                ...
                alt="Fashion Model in Party Dress"
